...
// Adding the children gave me a little bit of trouble because I was trying to add the
// children before defining the variable for the child.  Once I got the variable for the
// child name defined first, then it worked fine.

// 2) How difficult was it to add and delete properties outside of the object itself?
//  I thought this was a fairly easy and straight forward process.

// 3) What did you learn about manipulating objects in this challenge?
// It definitely reinforced the section in the reading where they talked about directly
// assigning values to objects.  Also, the idea of creating a new object as a variable
// and assigning that variable to another object.
